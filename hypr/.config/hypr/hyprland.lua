...
hl.on("hyprland.start", function()
    ...
    -- Announce "prefer dark" over the xdg-desktop-portal Settings interface
    -- (org.freedesktop.appearance color-scheme). This is what Brave/Chromium
    -- read for their "Device" theme, and what Firefox, Electron and GTK4 apps
    -- follow. The gtk-3.0/gtk-4.0 settings.ini files alone are not enough.
    hl.exec_cmd(scripts .. "/darkmode.sh")
